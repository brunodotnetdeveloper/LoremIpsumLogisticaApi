...
namespace LoremIpsumLogistica.Api.Controllers
{
    ...
    public class ClientsController(IClientsService clientsService) : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ClientViewModel>> Create(CreateClientViewModel clientViewModel)
        {
        ...
        public async Task<ActionResult> AddAddressToClient(int id, AddressViewModel addressViewModel)
        {
